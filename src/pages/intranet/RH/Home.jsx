        ...
        <main className='relative flex flex-row bg-white-30'>
            ...
            <div className='flex flex-col w-full'>
                <div className='bg-white flex flex-row w-full h-16 justify-between items-center'>
                    <h1 className='font-semibold text-xl items-center flex mx-7'>{'Dashboard > Gestion du personnel'}</h1>
                ...
                <div className='mt-10 mx-3'>
                    <RechercheBar text={'Ajouter un agent'} isBouton={true} />
                </div>
