...
const SideBar = () => {
    ...
    const menus = [
        { titre: 'Dashboard', icon: <DashboardOutlined />, gap: true, lien: '/Sig/RH' },
        { titre: 'Gestion du personnel', icon: <TeamOutlined />, lien: '/Sig/RH/Gestion du personnel' },
        {
            ...
            submenu: true,
            sousMenus: [
                { titre: 'Missions', icon: <CarryOutOutlined />, lien: '/' },
